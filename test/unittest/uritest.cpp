...
TEST(Uri, DefaultConstructor) {
    ...
    UriType u;
    EXPECT_TRUE(u.GetSchemeString() == RAPIDJSON_NULLPTR);
    EXPECT_TRUE(u.GetAuthString() == RAPIDJSON_NULLPTR);
    EXPECT_TRUE(u.GetPathString() == RAPIDJSON_NULLPTR);
    EXPECT_TRUE(u.GetBaseString() == RAPIDJSON_NULLPTR);
    EXPECT_TRUE(u.GetQueryString() == RAPIDJSON_NULLPTR);
    EXPECT_TRUE(u.GetFragString() == RAPIDJSON_NULLPTR);
    EXPECT_TRUE(u.GetString() == RAPIDJSON_NULLPTR);
