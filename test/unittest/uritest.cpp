...
TEST(Uri, DefaultConstructor) {
    ...
    UriType u;
    EXPECT_TRUE(u.GetSchemeString() == NULL);
    EXPECT_TRUE(u.GetAuthString() == NULL);
    EXPECT_TRUE(u.GetPathString() == NULL);
    EXPECT_TRUE(u.GetBaseString() == NULL);
    EXPECT_TRUE(u.GetQueryString() == NULL);
    EXPECT_TRUE(u.GetFragString() == NULL);
    EXPECT_TRUE(u.GetString() == NULL);
